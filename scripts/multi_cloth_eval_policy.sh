...
# Example usage:
# ./multi_cloth_eval_policy.sh cross_point_relative `CHECKPOINT`
# ./multi_cloth_eval_policy.sh scene_flow `CHECKPOINT` dataset.multi_cloth.hole=single dataset.multi_cloth.size=100
