...
NUM_DEMOS = 4
NUM_HOLES = 1 # 1 or 2
DATA_SPLIT = "val_ood_1" # train, val, or val_ood
NUM_CLOTHS = {
    "train": 100,
    "train_10": 10,
    "train_1": 1,
...
SEED = {
    ...
    "train_1": 50,
    "val": 100,
    "val_1": 60, # should be same cloth as train_1 
    "val_ood": 200,
    "val_ood_1": 70 # should be same cloth as train_1
}
