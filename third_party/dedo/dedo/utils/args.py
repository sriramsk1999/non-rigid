...
def get_args_parser():
    ...
    parser.add_argument('--tax3d', action='store_true',
                        help='Use TAX3D version of environment')
    parser.add_argument('--rollout_vid', action='store_true',
                        help='Whether to record rollouts')
